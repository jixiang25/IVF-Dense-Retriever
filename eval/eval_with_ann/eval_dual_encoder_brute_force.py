...
def build_faiss_index(args):
    ...
    faiss.write_index(
        index,
        os.path.join(args.index_dir, "brute_force_l2.index")
    )
...
def retrieve_from_index(args):
    ...
    with open(os.path.join(args.retrieved_result_dir, "top1000.brute_force.tsv"), "w") as fout:
...
def get_args():
    ...
    # model args
    parser.add_argument("--load_model_path", type=str, default="./data/msmarco-passage/checkpoints/step-340000")
    # data args
    ...
    # inference args
    parser.add_argument("--query_mode", type=str, default="dev")
